...
const getActivaPointsReward_js_1 = require("../handlers/rewards/getActivaPointsReward.js");
const router = express_1.default.Router();
exports.router = router;
//router.get("/editStudentProfile/:id", getStudentProfile);
router.post("/students", insertStudent_js_1.insertStudent);
//router.get("/students", getStudents);
router.get("/editStudentProfile/:id_student", getOneStudent_js_1.getOneStudent);
...
router.get("/points/:id_student", getActivaPointsReward_js_1.getActivaReward);
